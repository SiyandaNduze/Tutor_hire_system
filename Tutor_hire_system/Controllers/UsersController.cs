...
namespace Tutor_hire_system.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(Tutor_hire_systemContext context)
        {
            _context = context;
        }
        ...
        {
            var tutor_hire_systemContext = _context.User.Include(u => u.Role);
        ...
        public async Task<IActionResult> Create([Bind("UserId,FirstName,Surname,Email,PhoneNumber,Password,RoleId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,FirstName,Surname,Email,PhoneNumber,Password,RoleId")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
