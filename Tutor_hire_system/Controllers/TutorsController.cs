...
namespace Tutor_hire_system.Controllers
{
    public class TutorsController : Controller
    {
        ...
        public TutorsController(Tutor_hire_systemContext context)
        {
            _context = context;
        }
        ...
        {
            var tutor_hire_systemContext = _context.Tutor.Include(t => t.User);
        ...
        public async Task<IActionResult> Create([Bind("TutorId,Age,Qualification,Subject,Location,UserId")] Tutor tutor)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.User, "UserId", "Email", tutor.UserId);
            return View(tutor);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TutorId,Age,Qualification,Subject,Location,UserId")] Tutor tutor)
        {
            if (id != tutor.TutorId)
            {
                return NotFound();
